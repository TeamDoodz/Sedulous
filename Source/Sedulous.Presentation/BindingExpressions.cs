...
namespace Sedulous.Presentation
{
    ...
    internal partial class BindingExpressions
    {
        ...
        private static void RegisterPrecompiledComparisonDelegates()
        {
            ...
            comparerRegistry[typeof(Color?)] = new DataBindingComparer<Color?>((v1, v2) => v1 == v2);
            comparerRegistry[typeof(Matrix4x4)] = new DataBindingComparer<Matrix4x4>((v1, v2) => v1 == v2);
            comparerRegistry[typeof(Matrix4x4?)] = new DataBindingComparer<Matrix4x4?>((v1, v2) => v1 == v2);
            comparerRegistry[typeof(Point)] = new DataBindingComparer<Point>((v1, v2) => v1 == v2);
            comparerRegistry[typeof(Point?)] = new DataBindingComparer<Point?>((v1, v2) => v1 == v2);
            comparerRegistry[typeof(PointF)] = new DataBindingComparer<PointF>((v1, v2) => v1 == v2);
            comparerRegistry[typeof(PointF?)] = new DataBindingComparer<PointF?>((v1, v2) => v1 == v2);
            ...
            comparerRegistry[typeof(Radians?)] = new DataBindingComparer<Radians?>((v1, v2) => v1 == v2);
            comparerRegistry[typeof(System.Drawing.Rectangle)] = new DataBindingComparer<System.Drawing.Rectangle>((v1, v2) => v1 == v2);
            comparerRegistry[typeof(System.Drawing.Rectangle?)] = new DataBindingComparer<System.Drawing.Rectangle?>((v1, v2) => v1 == v2);
            ...
            comparerRegistry[typeof(RectangleD?)] = new DataBindingComparer<RectangleD?>((v1, v2) => v1 == v2);
            comparerRegistry[typeof(Size)] = new DataBindingComparer<Size>((v1, v2) => v1 == v2);
            comparerRegistry[typeof(Size?)] = new DataBindingComparer<Size?>((v1, v2) => v1 == v2);
            comparerRegistry[typeof(SizeF)] = new DataBindingComparer<SizeF>((v1, v2) => v1 == v2);
            comparerRegistry[typeof(SizeF?)] = new DataBindingComparer<SizeF?>((v1, v2) => v1 == v2);
